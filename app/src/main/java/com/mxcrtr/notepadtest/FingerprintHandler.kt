...
class FingerprintHandler(private val appContext: Context, private val mainActivity: MainActivity) : FingerprintManager.AuthenticationCallback() {
    ...
    override fun onAuthenticationSucceeded(
        ...
        mainActivity.onFingerprintSuccess()
    }
